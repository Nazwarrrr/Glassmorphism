 ...
 * Update data pribadi dan ubah password (sama seperti siswa)
 */
...
$user = fetch_one(
    "SELECT id_user, nama_lengkap, username FROM users WHERE id_user = ?",
    [$id_user]
);
    ...
    <div class="flex flex-col md:flex-row min-h-[calc(100vh-64px)] relative z-10">
        ...
        <main class="flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto">
            ...
            <div class="mt-6 bg-slate-50/40 border border-slate-200 rounded-2xl p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                        ...
                        <p class="font-semibold text-slate-800">Admin / Petugas Perpustakaan</p>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-6 bg-blue-50/40 border border-blue-200 rounded-2xl p-6">
                <h3 class="text-lg font-bold text-blue-900 mb-4"><i class="fas fa-tools"></i> Informasi Sistem</h3>
